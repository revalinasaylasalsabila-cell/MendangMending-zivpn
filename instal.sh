...
clear
echo "================================================="
echo "   PREMIUM ZIVPN INSTALLER - MendangMending.co   "
echo "================================================="

read -p "Masukkan License Key Anda: " LICENSE_KEY
IP_VPS=$(curl -s ifconfig.me)

echo "Memeriksa validitas lisensi..."

# (Ini adalah contoh URL API, nantinya diganti dengan web panel Anda)
VALIDASI=$(curl -s "https://api.domainanda.com/check-license?key=$LICENSE_KEY&ip=$IP_VPS")

# UNTUK SEMENTARA, KITA GUNAKAN PASSWORD LOKAL UNTUK TESTING
if [ "$LICENSE_KEY" != "MENDANGMENDING2026" ]; then
    echo "GAGAL: License Key salah atau kadaluarsa!"
    exit 1
fi
...
sleep 2
# =================================================
# KODE ASLI ZIVPN BERADA DI BAWAH GARIS INI
# =================================================
